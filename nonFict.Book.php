...
<html>
	<head>
		...
		<title>Non-Fiction Book List</title>
...
<div class="contain">
	...
	<div class="sub-navbar-1">
		...
		<div class="container">
			...
			<br />
			 <br /> <br /> <br />
			<h2> CHILDREN NON-FICTION </h2>
			<?php
				$query = "SELECT * FROM book where category_id='1'";
			...
			<div class="col-lg-4 d-flex flex-column justify-content-center align-items-center">
				<form method="post" action="nonFict.Book.php?action=add&id=<?php echo $row["id"]; ?>">
		...
		<hr class="style-eight">
			<h2> ADULT NON-FICTION </h2>
			<br /><br />
		<div class="container">
			<br />
			<?php
				$query = "SELECT * FROM book where category_id='2'";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
	...
	<hr class="style-eight">
			<h2> TEEN NON-FICTION </h2>
			<br /><br />
			<?php
				$query = "SELECT * FROM book where category_id='3'";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
