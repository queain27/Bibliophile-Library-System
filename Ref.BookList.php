...
<html>
	<head>
		...
		<title>Reference Book List</title>
...
<div class="contain">
	...
	<div class="sub-navbar-1">
		...
		<div class="container">
			...
			<br />
			 <br /> <br /> <br />
			<h2> CHILDREN REFERENCE BOOK </h2>
			<?php
				$query = "SELECT * FROM book where category_id='4'";
			...
			<div class="col-lg-4 d-flex flex-column justify-content-center align-items-center">
				<form method="post" action="Ref.BookList.php?action=add&id=<?php echo $row["id"]; ?>">
		...
		<hr class="style-eight">
			<h2> ADULT REFERENCE LIST </h2>
			<br /><br />
		<div class="container">
			<br />
			<?php
				$query = "SELECT * FROM book where category_id='5'";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
	...
	<hr class="style-eight">
			<h2> TEEN REFERENCE LIST </h2>
			<br /><br />
			<?php
				$query = "SELECT * FROM book where category_id='6'";
				$result = mysqli_query($connect, $query);
				if(mysqli_num_rows($result) > 0)
				{
					while($row = mysqli_fetch_array($result))
