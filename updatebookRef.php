...
<div class="contain">
	...
	<li><a href="About Us.html"><i class="fa fa-address-card" ></i>About us</a></li> 
	 <li><a href="#.html"><i class="fa fa-user-circle-o"></i>
	 <div class="sub-navbar-1">
	    <ul>
  ...
  {background:#B2D9EA; 
   ...
   <h1>Register Book </h1>
    <form id="formbook" name="formbook" method="POST" action="updatebookengine.php" enctype="multipart/form-data">
	  <div class="row1">
      Book ID:
	  <input type="text"  name="txtbookid" id="txtbookid"></div>
	  <div class="row1">
	  Title Book:
	 ...
	 <option>----Choose Category---</option>
         <?php
	        ...
	        {
				if($row['category_id']==4||$row['category_id']==5||$row['category_id']==6)
				{
		 ?>
	   ...
	   <div class="row1">
         ...
         <!----tukar--><a href="Ref.BookList.php" class="btn">Back</a>
	   </div>
	  </form>
